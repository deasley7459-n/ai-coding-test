...
class UserApiTest {
    ...
    void fullUserLifecycle() {
        ...
        assertThat(created.getBody().get("code")).isEqualTo(0);

        Map<String, Object> createdUser = (Map<String, Object>) created.getBody().get("data");
        ...
        ResponseEntity<Map<String, Object>> afterUpdate = restTemplate.exchange(
                "/api/users/" + id, HttpMethod.GET, null, JSON_MAP);
        Map<String, Object> updatedUser = (Map<String, Object>) afterUpdate.getBody().get("data");
        ...
        assertThat(missing.getBody().get("code")).isEqualTo(404);
    }
